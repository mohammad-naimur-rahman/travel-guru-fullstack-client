        ...
        <footer className='py-5 px-3'>
            <div className="row">
                ...
                <div className="col-lg-3 col-md-6 p-3">
                    ...
                    <ul className='footer-links'>
                        <p>Phone: +8801888 333 222</p>
                        <p>Email: naeemhasan28@gmail.com</p>
                        <p>1423, Dhaka, Bangladesh</p>
                    </ul>
                </div>
            </div>
            <p className='text-center pt-3'>Copyright &copy; reserved {(new Date()).getFullYear()} by <cite>Naimur Rahman</cite></p>
        </footer>
    );
};
